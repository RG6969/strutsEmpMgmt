...
public class JDBCUtility {
    ...
    public String getPropertyValue(String param) {
        ...
        try {
            ...
            InputStream path = JDBCUtility.class.getClassLoader().getResourceAsStream("settings.properties");
			

            BufferedReader input = new BufferedReader(new InputStreamReader(path, "UTF-8"));
